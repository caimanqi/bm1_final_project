...
```{r linear_model from stepwise}
reg <- lm(losdays2_log ~ + is30dayreadmit + ageyear +  cindex + evisit + ageyear + gender +  maritalstatus + insurancetype + bpsystolic + o2sat + heartrate +  respirationrate + bpdiastolic, ghproject_tidy)
