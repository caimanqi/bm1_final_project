...
newtable <- cbind(p1, p2, p3, p4, p5, p6, p7)
newtable %>% 
  DT::datatable()
```
...
reg <- lm(losdays2_log ~ + is30dayreadmit + ageyear + cindex + evisit +  gender + maritalstatus + insurancetype + bpsystolic + o2sat + heartrate +  respirationrate + bpdiastolic, ghproject_tidy)
...
# Sample chooses 2709 observations from 2709, with replacement
...
# Repeat 1000 times to get the estimates, SEs ad bias
